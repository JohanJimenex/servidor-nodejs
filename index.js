...
//Rutas, le colocamos una ruta preliminar como prefijo
app.use('/api/auth', require('./routes/auth.routes.js'));// divimos ls rutas en archivos separados y le agregamos un prefijo para estar mas organizado, así no tener que agregarselo a todos el api/auth
...
//Esta variable process.env.PORT viene dle arcvhio .env
