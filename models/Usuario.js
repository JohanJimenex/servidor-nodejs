...
const UsuarioSchema = Schema(
  ...
  { collection: "NombreColeccionnDeseado" }
); // con esto personalzamos el nombre de la coleccion en vez de dejarlo por defecto es opcional
...
//Antes de exportar, llamamos la funcion model que crea una clase (modelo) 'Usuario' con las propidades definida en el objeto Schema
// esto a su vez es el nombre de la tabla/entidad en la DB y le pone automaticamente la letra 'S' quedando como 'Usuarios'

let usuario = model("Usuario", UsuarioSchema);
